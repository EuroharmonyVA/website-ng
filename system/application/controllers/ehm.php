...
class Ehm extends CI_Controller
{
    ...
    function index($media_select = NULL)
    {
        ...
        $this->rss->set_url(array(    //'http://www.fly-euroharmony.com/forum/index.php?action=.xml;type=rss2;sa=recent;limit=5',
            'http://www.fly-euroharmony.com/forum/index.php?action=.xml;type=rss2;sa=news;limit=10',
        ));
